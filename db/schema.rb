...
ActiveRecord::Schema.define(version: 2020_11_01_164417) do
  ...
  create_table "pg_transactions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "status"
    t.string "charge_id"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cart_id"], name: "index_pg_transactions_on_cart_id"
  end
  ...
  add_foreign_key "pg_transactions", "carts"
